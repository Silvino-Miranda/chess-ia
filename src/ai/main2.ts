...
//     board
//       .getPieceAt(bestBoardData.lastMove.origin.x, bestBoardData.lastMove.origin.y)
//       .move(bestBoardData.lastMove.destination.x, bestBoardData.lastMove.destination.y, board);
//   }
// }
...
//     return move.destinations.length > 0;
//   });
